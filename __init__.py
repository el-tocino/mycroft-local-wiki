...
class LocalWiki(MycroftSkill):

    # The constructor of the skill, which calls MycroftSkill's constructor
    def __init__(self):
        super(LocalWiki, self).__init__(name="LocalWiki")
    ...
    # each of the skill's intents is triggered: in this case, it simply
